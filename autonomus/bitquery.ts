...
const query = `
 query {
    ...
    DEXTrades(
      ...
      where: {Trade: {Buy: {PriceInUSD: {gt: 0.000025}, Currency: {MintAddress: {notIn: ["11111111111111111111111111111111"]}}}, Sell: {AmountInUSD: {gt: "10"}}, Dex: {ProtocolName: {is: "pump"}}}, Transaction: {Result: {Success: true}}}
    ) {
      Trade {
        Buy {
          Currency {
